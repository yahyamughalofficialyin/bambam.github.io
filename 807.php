...
<link rel="stylesheet" id="give-google-font-montserrat-css" href="https://fonts.googleapis.com/css?family=Montserrat%3A400%2C500%2C600%2C700&amp;display=swap&amp;ver=2.32.0" media="all">
<link rel="stylesheet" id="give-sequoia-template-css-css" href="css/give-sequoia-template.css" media="all">
<style id="give-sequoia-template-css-inline-css">
			...
			.give-btn {
				border: 2px solid #91212e !important;
				background: #91212e !important;
			}
			.give-btn:hover {
				background: #91212e !important;
			...
			.give-btn:focus {
				box-shadow: 0 0 8px #91212e;
			}
			.payment .give-gateway-option-selected:focus-within .give-gateway-option::before,
			.choose-amount .give-total-wrap .give-donation-amount:focus-within {
				border-color: #91212e !important;
			}
			.give-donation-level-btn {
				border: 2px solid #91212e !important;
			}
			.give-donation-level-btn.give-default-level {
				color: #91212e !important;
				background: #fff !important;
				transition: background 0.2s ease, color 0.2s ease;
			}
			.give-donation-level-btn.give-default-level:hover {
				color: #91212e !important; background: #fff !important;
			}
			.give-input:focus, .give-select:focus {
				border: 1px solid #91212e !important;
			}
			.checkmark {
				border-color: #91212e !important;
				color: #91212e !important;
...
<link rel="stylesheet" id="kadence-givewp-iframe-fonts-css" href="https://fonts.googleapis.com/css?family=Jost%3Aregular%2C700%2C500%7CDays+One%3Aregular&amp;display=swap&amp;ver=1.1.42" media="all">
...
var give_global_vars = {"ajaxurl":"https:\/\/startertemplatecloud.com\/g71\/wp-admin\/admin-ajax.php","checkout_nonce":"cea64792e9","currency":"USD","currency_sign":"$","currency_pos":"before","thousands_separator":",","decimal_separator":".","no_gateway":"Please select a payment method.","bad_minimum":"The minimum custom donation amount for this form is","bad_maximum":"The maximum custom donation amount for this form is","general_loading":"Loading...","purchase_loading":"Please Wait...","textForOverlayScreen":"<h3>Processing...<\/h3><p>This will only take a second!<\/p>","number_decimals":"0","is_test_mode":"1","give_version":"2.32.0","magnific_options":{"main_class":"give-modal","close_on_bg_click":false},"form_translation":{"payment-mode":"Please select payment mode.","give_first":"Please enter your first name.","give_last":"Please enter your last name.","give_email":"Please enter a valid email address.","give_user_login":"Invalid email address or username.","give_user_pass":"Enter a password.","give_user_pass_confirm":"Enter the password confirmation.","give_agree_to_terms":"You must agree to the terms and conditions."},"confirm_email_sent_message":"Please check your email and click on the link to access your complete donation history.","ajax_vars":{"ajaxurl":"https:\/\/startertemplatecloud.com\/g71\/wp-admin\/admin-ajax.php","ajaxNonce":"0579d150c0","loading":"Loading","select_option":"Please select an option","default_gateway":"manual","permalinks":"1","number_decimals":0},"cookie_hash":"0bba63dc2a928c7e4b6cf55013919c02","session_nonce_cookie_name":"wp-give_session_reset_nonce_0bba63dc2a928c7e4b6cf55013919c02","session_cookie_name":"wp-give_session_0bba63dc2a928c7e4b6cf55013919c02","delete_session_nonce_cookie":"0"};
var giveApiSettings = {"root":"https:\/\/startertemplatecloud.com\/g71\/wp-json\/give-api\/v2\/","rest_base":"give-api\/v2"};
var give_global_vars = {"ajaxurl":"https:\/\/startertemplatecloud.com\/g71\/wp-admin\/admin-ajax.php","checkout_nonce":"cea64792e9","currency":"USD","currency_sign":"$","currency_pos":"before","thousands_separator":",","decimal_separator":".","no_gateway":"Please select a payment method.","bad_minimum":"The minimum custom donation amount for this form is","bad_maximum":"The maximum custom donation amount for this form is","general_loading":"Loading...","purchase_loading":"Please Wait...","textForOverlayScreen":"<h3>Processing...<\/h3><p>This will only take a second!<\/p>","number_decimals":"0","is_test_mode":"1","give_version":"2.32.0","magnific_options":{"main_class":"give-modal","close_on_bg_click":false},"form_translation":{"payment-mode":"Please select payment mode.","give_first":"Please enter your first name.","give_last":"Please enter your last name.","give_email":"Please enter a valid email address.","give_user_login":"Invalid email address or username.","give_user_pass":"Enter a password.","give_user_pass_confirm":"Enter the password confirmation.","give_agree_to_terms":"You must agree to the terms and conditions."},"confirm_email_sent_message":"Please check your email and click on the link to access your complete donation history.","ajax_vars":{"ajaxurl":"https:\/\/startertemplatecloud.com\/g71\/wp-admin\/admin-ajax.php","ajaxNonce":"0579d150c0","loading":"Loading","select_option":"Please select an option","default_gateway":"manual","permalinks":"1","number_decimals":0},"cookie_hash":"0bba63dc2a928c7e4b6cf55013919c02","session_nonce_cookie_name":"wp-give_session_reset_nonce_0bba63dc2a928c7e4b6cf55013919c02","session_cookie_name":"wp-give_session_0bba63dc2a928c7e4b6cf55013919c02","delete_session_nonce_cookie":"0"};
var giveApiSettings = {"root":"https:\/\/startertemplatecloud.com\/g71\/wp-json\/give-api\/v2\/","rest_base":"give-api\/v2"};
</script>
<script src="js/give.js" id="give-js"></script>
<meta name="robots" content="noindex,nofollow">
        </head>
        <body class="give-form-templates">
        	<div id="give-form-807-wrap" class="give-form-wrap give-embed-form give-viewing-form-in-iframe">
		<div class="give-form-navigator">
    <button class="back-btn"><i class="fas fa-chevron-left"></i></button>
    <p class="title"></p>
</div>
<div class="give_error give_warning" id="give_error_test_mode"><p><strong>Notice:</strong> Test mode is enabled. While in test mode no live donations are processed.</p></div>			<form id="give-form-807-1" class="give-form give-form-807 give-form-type-multi" action="https://startertemplatecloud.com/g71/give/807/?payment-mode=manual&amp;form-id=807" data-id="807-1" data-currency_symbol="$" data-currency_code="USD" data-currency_position="before" data-thousands_separator="," data-decimal_separator="." data-number_decimals="0" method="post">
				<!-- The following field is for robots only, invisible to humans: -->
				<span class="give-hidden" style="display: none !important;">
					<label for="give-form-honeypot-807"></label>
					<input id="give-form-honeypot-807" type="text" name="give-honeypot" class="give-honeypot give-hidden">
				</span>

					<input type="hidden" name="give-form-id-prefix" value="807-1">
	<input type="hidden" name="give-form-id" value="807">
	<input type="hidden" name="give-form-title" value="THE STRANGE LIVES">
	<input type="hidden" name="give-current-url" value="https://startertemplatecloud.com/g71/give/807/">
	<input type="hidden" name="give-form-url" value="https://startertemplatecloud.com/g71/give/807/">
			<input type="hidden" name="give-form-minimum" value="5">
		<input type="hidden" name="give-form-maximum" value="1000000">
		<input type="hidden" name="give-form-hash" value="6904c13e12" data-time="1699697078" data-nonce-life="86400" data-donor-session="0"><input type="hidden" name="give-price-id" value="3">
<div class="give-section introduction">
    <h2 class="headline">
        Upcoming Project: THE STRANGE LIVES    </h2>
            <div class="seperator"></div>
        <p class="description">
            Orci a scelerisque purus semper eget duis at tellus. Quam viverra orci sagittis eu volutpat. Rhoncus dolor purus non enim. Sit amet consectetur adipiscing elit ut.        </p>
                <div class="image">
            <img src="images/pexels-cottonbro-8387455.jpg">
        </div>
    
    <button class="give-btn advance-btn">Donate Now<i class="fas fa-chevron-right"></i></button></div><div class="give-section choose-amount"><p class="content">How much would you like to donate? As a contributor to Filmaker we make sure your donation goes directly to supporting our cause. Thank you for your generosity!</p>		<div class="give-total-wrap">
	...
	<fieldset id="give-payment-mode-select">
		...
		<div id="give-payment-mode-wrap">
						<ul id="give-gateway-radio-list">
							...
							<input type="radio" name="payment-mode" class="give-gateway" id="give-gateway-manual-807-1" value="manual" checked="checked">
							<label for="give-gateway-manual-807-1" class="give-gateway-option" id="give-gateway-option-manual"> Donate with Test Donation</label>
						</li>
												<li>
							<input type="radio" name="payment-mode" class="give-gateway" id="give-gateway-offline-807-1" value="offline">
							<label for="give-gateway-offline-807-1" class="give-gateway-option" id="give-gateway-option-offline"> Donate with Offline Donation</label>
						</li>
									</ul>
					</div>
			</fieldset>
