...
<meta name="robots" content="noindex,nofollow">
        ...
        <body class="give-form-templates">
        	<div id="give-form-823-wrap" class="give-form-wrap give-embed-form give-viewing-form-in-iframe">
		<div class="give-form-navigator">
    <button class="back-btn"><i class="fas fa-chevron-left"></i></button>
    <p class="title"></p>
</div>
<div class="give_error give_warning" id="give_error_test_mode"><p><strong>Notice:</strong> Test mode is enabled. While in test mode no live donations are processed.</p></div>			<form id="give-form-823-1" class="give-form give-form-823 give-form-type-multi" action="https://startertemplatecloud.com/g71/give/807-2/?payment-mode=manual&amp;form-id=823" data-id="823-1" data-currency_symbol="$" data-currency_code="USD" data-currency_position="before" data-thousands_separator="," data-decimal_separator="." data-number_decimals="0" method="post">
				<!-- The following field is for robots only, invisible to humans: -->
				<span class="give-hidden" style="display: none !important;">
					<label for="give-form-honeypot-823"></label>
					<input id="give-form-honeypot-823" type="text" name="give-honeypot" class="give-honeypot give-hidden">
				</span>

					<input type="hidden" name="give-form-id-prefix" value="823-1">
	<input type="hidden" name="give-form-id" value="823">
	<input type="hidden" name="give-form-title" value="DANGEROUS MAN">
	<input type="hidden" name="give-current-url" value="https://startertemplatecloud.com/g71/give/807-2/">
	<input type="hidden" name="give-form-url" value="https://startertemplatecloud.com/g71/give/807-2/">
			<input type="hidden" name="give-form-minimum" value="5">
		<input type="hidden" name="give-form-maximum" value="1000000">
		<input type="hidden" name="give-form-hash" value="65f64cc214" data-time="1699697078" data-nonce-life="86400" data-donor-session="0"><input type="hidden" name="give-price-id" value="3">
<div class="give-section introduction">
    <h2 class="headline">
        Upcoming Project: DANGEROUS MAN    </h2>
        ...
        <p class="description">
            Orci a scelerisque purus semper eget duis at tellus. Quam viverra orci sagittis eu volutpat. Rhoncus dolor purus non enim. Sit amet consectetur adipiscing elit ut.        </p>
                <div class="image">
            <img src="images/taylor-brandon-x7K0cE82DZs-unsplash.jpg">
        </div>
	...
	<fieldset id="give-payment-mode-select">
		...
		<div id="give-payment-mode-wrap">
						<ul id="give-gateway-radio-list">
							...
							<input type="radio" name="payment-mode" class="give-gateway" id="give-gateway-manual-823-1" value="manual" checked="checked">
							<label for="give-gateway-manual-823-1" class="give-gateway-option" id="give-gateway-option-manual"> Donate with Test Donation</label>
						</li>
												<li>
							<input type="radio" name="payment-mode" class="give-gateway" id="give-gateway-offline-823-1" value="offline">
							<label for="give-gateway-offline-823-1" class="give-gateway-option" id="give-gateway-option-offline"> Donate with Offline Donation</label>
						</li>
									</ul>
					</div>
			</fieldset>
